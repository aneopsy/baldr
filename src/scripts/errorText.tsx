...
export default {
  ...
  [errorCodes.metamaskLocked]:
    'Please check Metamask is configured properly and your account is unlocked',
  [errorCodes.metamaskWrongNetwork]:
    'Wrong network selected in Metamask. Please select appropriate network.',
  [errorCodes.metamaskWrongAccount]:
    "Wrong account selected in Metamask. Please select correct 'From' account",
